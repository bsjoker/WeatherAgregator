package bs.joker.weatherforecast.rest.api;
...
import bs.joker.weatherforecast.rest.model.response.AstronomyWundergroundResponse;
import bs.joker.weatherforecast.rest.model.response.CurrentWeatherbitIOResponse;
import bs.joker.weatherforecast.rest.model.response.CurrentWundergroundResponse;
import bs.joker.weatherforecast.rest.model.response.Daily5ForecastAccuWeatherResponse;
import bs.joker.weatherforecast.rest.model.response.Daily5ForecastDarkskyResponse;
import bs.joker.weatherforecast.rest.model.response.Daily5ForecastWeatherbitIOResponse;
import bs.joker.weatherforecast.rest.model.response.GeoNamesResponse;
import bs.joker.weatherforecast.rest.model.response.HourlyForecastDarkskyResponse;
import bs.joker.weatherforecast.rest.model.response.HourlyForecastWeatherbitIOResponse;
import bs.joker.weatherforecast.rest.model.response.HourlyForecastWundergroundResponse;
import bs.joker.weatherforecast.rest.model.response.WeeklyForecastWundergroundResponse;
